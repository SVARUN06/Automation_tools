...
fname2 = config_folder + "new template for 9010.txt"
...
if not filecmp.cmp(fname1, fname2):
        print("Golden Template Vs Current Template are not equal")
        difference = difflib.HtmlDiff().make_file(lines1,lines2,f1,f2)
        difference_report = open('C:\\Users\\svaru\\OneDrive\\Desktop\\Goldenconfig\\report\\Audit_diff_template_2.html','w')
        ...
        diff2_report = open('C:\\Users\\svaru\\OneDrive\\Desktop\\Goldenconfig\\report\\Audit_diff_template_2.csv','w')
...
'''else:
    ...
    print("Audit file Generating.....")
    difference_audit = open('C:\\Users\\svaru\\OneDrive\\Desktop\\Goldenconfig\\report\\audit_diff_device.html','w')
    difference_audit.write(audit_diff)
    difference_audit.close()
    print("ASR:Entry_Config Vs Exit_config Diff_Report generated successfully")'''
    
#Run irresepective of the template comparision
print("Golden Template Vs new template are not equal: Device config are compared here")
entry_file = golden_folder + "S1CW-E-709_A.txt"
exit_file = config_folder + "S1CW-E-709_B.txt"
print entry_file
print exit_file
...
difference_audit = open('C:\\Users\\svaru\\OneDrive\\Desktop\\Goldenconfig\\report\\audit_diff_device_2.html','w')
difference_audit.write(audit_diff)
print("Config Audit file HTML Generating 100%")
difference_audit.close()
...
diff3_report = open('C:\\Users\\svaru\\OneDrive\\Desktop\\Goldenconfig\\report\\Audit_diff_running_2.csv','w')
